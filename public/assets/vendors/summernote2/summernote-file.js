				...
				let body = [
					'<div class="form-group" style="font-size: 13px">',
						'<label class="checkbox" style="cursor: pointer">',
                            '<input type="checkbox" id="tampilkanLink" name="tampilkanLink" value="ya">',
					...
					'<div class="form-group note-form-group note-group-select-from-files">',
						'<label class="note-form-label">Upload Berkas</label>',
						'<input class="note-file-input note-form-control note-input" ',
						' type="file" name="files" accept="*/*">',
					'</div>',
					fileLimitation,
					'<hr class="mt-4">',
					'<div style="font-size: 13px;position: relative;padding-left: 20px;padding-right: 20px;margin: auto;width: max-content;margin-top: -26px;background: var(--background-secondary-color);padding-right: 13px;">Atau masukkan link</div>',
					'<div class="form-group note-group-image-url mt-2" style="overflow:auto;">',
					'<label class="note-form-label">' + lang.file.url + '</label>',
					'<input class="note-file-url form-control note-form-control note-input ',
					' col-md-12" type="text" placeholder="Masukkan url file">',
					'</div>'
				].join('');
