					...
					<div class="col-lg-4 col-md-6">
						<article class="blog-post style-three wow pixFadeLeft" data-wow-delay="0.4s">
							<div class="feature-image">
								<a href="#">
									<img src="{{ env('APP_URL').'/'.$p->thumbnail }}" alt="blog-thumb" style="width: 100%;max-height: 300px;min-height: 280px;">
								</a>
							</div><!-- /.feature-image -->
							<div class="blog-content">
								...
								<p class="d-none" style="max-height: 52px;overflow: hidden;text-overflow: ellipsis;display: -webkit-box;-webkit-line-clamp: 3;-webkit-box-orient: vertical;">{!! strip_tags($p->body) !!}</p>
								...
								<div class="mt-4">
									...
									<a href="https://wa.me/+62852623117xx" target="_blank" class="btn btn-primary">Pesan</a>
								</div>
