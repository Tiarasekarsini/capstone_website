                            ...
                            <div class="row row--md">
                                <div class="col-12 form-group form-group--lg">
                                    ...
                                    <div class="input-group">
                                        <input class="input" type="text" id="title" name="title" placeholder="Input title" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row row--md">
                                <div class="col-12 form-group form-group--lg">
                                    ...
                                    <div class="input-group">
                                        <input class="input" type="text" id="harga" name="harga" placeholder="Input harga" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row row--md">
                                <div class="col-12 form-group form-group--lg">
                                    ...
                                    <div class="input-group input-group--append">
                                        <select class="input input--fluid" name="category_id" id="category_id" data-placeholder="Pilih Operator" required>
        ...
        $.ajax({
            ...
            success: function(res){
                if(res.status && res.status=="berhasil"){
                    ...
                    $('#bodyThumbnail').html('<img src="{{ env('APP_URL') }}/'+res.post.thumbnail+'" class="mb-2" style="max-width: 300px; max-height: 200px">')
            ...
            error: function(a, b, c){
                ...
                if(res.message && res.errors){
                    $.each(res.errors, function(i,v){
                        ...
                        $('<div/>').addClass('input-error error text-danger').html('<ol class="pl-3">'+errors.join('')+'</ol>').insertAfter($('#'+i).parent())
                    })
