...
<head>
    ...
    <link rel="stylesheet"
        href="{{ env('APP_URL') }}/assets/arion/vendor/datatable/css/dataTables.bootstrap4.min.css" />
    ...
    <link rel=icon
        href="<?= isset($pengaturan_situs->logo_favicon) && $pengaturan_situs->logo_favicon ? resource_url($pengaturan_situs->logo_favicon) : null ?>"
    ...
    <style>
        ...
        html[data-theme=dark] div.dt-buttons>.dt-button:first-child,
        div.dt-buttons>div.dt-button-split .dt-button:first-child {
            -webkit-filter: none;
            filter: none;
        }
        ...
        #sectionThumbnail::-webkit-scrollbar {
            width: 6px;
            height: 6px;
        }
        ...
        #sectionThumbnail::-webkit-scrollbar-track {
            background: unset;
        }

        body::-webkit-scrollbar-thumb,
        #sectionThumbnail::-webkit-scrollbar-thumb {
            background: var(--scrollbar-color);
            border-radius: 10px;
        }

        body::-webkit-scrollbar-thumb:hover,
        #sectionThumbnail::-webkit-scrollbar-thumb:hover {
...
<body class="page-home">
    ...
    <div class="page-wrapper">
                            ...
                            <div class="header__language dropdown">
                                <div class="lang-menu dropdown-menu">
                                    <button class="lang-menu__button dropdown-menu__item" tabindex="0">
                                        <img class="lang-menu__icon"
                                            src="{{ env('APP_URL') }}/assets/arion/img/content/flags/us.svg"
                                            alt="#"><span class="lang-menu__text">EN</span>
                                    </button>
                                    <button class="lang-menu__button dropdown-menu__item active" tabindex="0">
                                        <img class="lang-menu__icon"
                                            src="{{ env('APP_URL') }}/assets/arion/img/content/flags/id.svg"
                                            alt="#"><span class="lang-menu__text">ID</span>
                                    </button>
                                    <div class="lang-menu__separate"></div><a
                                        class="lang-menu__button lang-menu__button--all dropdown-menu__item"
                                        href="{{ env('APP_URL') }}/assets/arion/#" tabindex="0">Learn</a>
                                </div>
                            </div>
                            <div class="header__profile dropdown">
                                <a class="header__profile-toggle dropdown__toggle"
                                    href="assets-{{ env('APP_URL') }}/admin/#" data-toggle="dropdown">
                                    <div class="header__profile-image"><span
                                            class="header__profile-image-text">MA</span>
                                        <img src="{{ env('APP_URL') . (Session::get('foto') ? Session::get('foto') : '/assets/images/user.png') }}"
                                            alt="#" />
                                    </div>
                    ...
                    <nav class="sidebar__nav">
                        <ul class="sidebar__menu">
                            ...
                            <li class="sidebar__menu-item">
                                <a class="sidebar__link {{ isset($menu) && $menu == 'home' ? 'active' : null }}"
                                    href="{{ env('APP_URL') . '/admin' }}" aria-expanded="true">
                                    <span class="sidebar__link-icon"><svg class="icon-icon-dashboard">
                            ...
                            <li class="sidebar__menu-item">
                                <a class="sidebar__link {{ isset($menu) && $menu == 'mypost' ? 'active' : null }}"
                                    href="{{ env('APP_URL') . '/admin/mypost' }}" aria-expanded="true">
                                    <span class="sidebar__link-icon"><svg class="icon-icon-send">
                            ...
                            <li class="sidebar__menu-item">
                                <a class="sidebar__link {{ isset($menu) && $menu == 'category' ? 'active' : null }}"
                                    href="{{ env('APP_URL') . '/admin/category' }}" aria-expanded="true">
                                    <span class="sidebar__link-icon"><svg class="icon-icon-grid">
                            ...
                            <li class="sidebar__menu-item">
                                <a class="sidebar__link" href="{{ env('APP_URL') . '/' }}" aria-expanded="false">
                                    <span class="sidebar__link-icon"><svg class="icon-icon-settings">
                                            <use xlink:href="#icon-logout"></use>
                                        </svg></span>
                    ...
                    <div class="modal__content">
                        <div class="modal__body">
                            <div class="modal__container">
                                <img class="modal-success__icon" id="iconModalAlert-fail"
                                    src="{{ env('APP_URL') }}/assets/arion/img/content/checked-failed.svg"
                                    width="80px" alt="#">
                                <img class="modal-success__icon" id="iconModalAlert-success"
                                    src="{{ env('APP_URL') }}/assets/arion/img/content/checked-success.svg"
                                    width="80px" alt="#">
                        ...
                        <div class="modal-compact__buttons">
                            <div class="modal-compact__button-item">
                                <button class="modal-compact__button button" data-dismiss="modal" data-modal=""
                                    id="btnMoreModal" disabled><span class="button__text"></span></button>
                            </div>
                            <div class="modal-compact__button-item">
        ...
        <script src="{{ env('APP_URL') }}/assets/vendors/summernote2/summernote-gallery.min.js" type="text/javascript">
        </script>
        <script src="{{ env('APP_URL') }}/assets/vendors/summernote2/mysummernote.js" type="text/javascript"></script>

        <script src="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.20/lang/summernote-id-ID.min.js"
            integrity="sha512-viTUgqrk+5XInorfp/0NMZSI3mSLwBb+mKXfce4CiIhW8D9b1+lq+RxyahOycN1y+VkgGC7vwCFFB6GQHFhcsQ=="
        ...
        <script>
            ...
            function alertShow(status, text, alertBody = '#alert-body') {
                $(alertBody).html('<div class="alert ' + (status == 'berhasil' ? 'alert-success' : 'alert-danger') +
