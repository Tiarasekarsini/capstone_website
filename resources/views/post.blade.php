			...
			<div class="container mt-5">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-4">
						<img src="{{ env('APP_URL').'/assets/images/iklan1.png' }}" class="mb-2" alt="blog-thumb" style="width: 100%;">
					...
					<div class="col-lg-8 col-md-8">
						<article class="blog-post style-three wow pixFadeLeft" data-wow-delay="0.4s">
							<div class="feature-image">
								<a href="#">
									<img src="{{ env('APP_URL').'/'.$post->thumbnail }}" alt="blog-thumb" style="width: 100%;">
								</a>
							</div><!-- /.feature-image -->
							<div class="blog-content">
								...
								<div class="mt-4">
									<a href="https://wa.me/+62852623117xx" target="_blank" class="app-btn-two btn-light wow flipInX" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: flipInX;">
										<i><img src="{{ env('APP_URL') }}/assets/images/whatsapp.png" style="width:38px" alt=""></i>
										<span class="btn-text">
											<span class="text-top">Pesan Via</span>
											<span>WhatsApp</span>
										</span>
									</a>
									<a href="{{ url()->previous() }}" style="margin-top: -7px;" class="btn btn-primary pt-3 pb-3">Kembali</a>
								</div>
